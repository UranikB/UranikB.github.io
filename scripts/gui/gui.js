...
function hideFirst() {
    ...
    document.getElementById("parse-grammar-button").style.backgroundColor = "ghostwhite";
    document.getElementById("startproduction-input").style.backgroundColor = "ghostwhite";
